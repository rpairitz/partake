    ...
    return(
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Anime &#127983;" checked={isAnimeSelected} onPress={() => setIsAnimeSelected(!isAnimeSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Astrology &#9804;" checked={isAstroSelected} onPress={() => setIsAstroSelected(!isAstroSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Baking &#127856;" checked={isBakeSelected} onPress={() => setIsBakeSelected(!isBakeSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Beer Tasting &#127866;" checked={isBeerSelected} onPress={() => setIsBeerSelected(!isBeerSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Book Discussion &#128218;" checked={isBookSelected} onPress={() => setIsBookSelected(!isBookSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Cars &#128663;" checked={isCarsSelected} onPress={() => setIsCarsSelected(!isCarsSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Coffee &#9749;" checked={isCofSelected} onPress={() => setIsCofSelected(!isCofSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Cooking &#127859;" checked={isCookSelected} onPress={() => setIsCookSelected(!isCookSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Gardening &#127793;" checked={isGarSelected} onPress={() => setIsGarSelected(!isGarSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Home Improvement &#127969;" checked={isHomeSelected} onPress={() => setIsHomeSelected(!isHomeSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Juggling &#129337;" checked={isJugSelected} onPress={() => setIsJugSelected(!isJugSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Karaoke &#127908;" checked={isKarSelected} onPress={() => setIsKarSelected(!isKarSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Magic &#10024;" checked={isMagSelected} onPress={() => setIsMagSelected(!isMagSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Writing &#128221;" checked={isWriteSelected} onPress={() => setIsWriteSelected(!isWriteSelected)} />

                <Text style={styles.section}>Arts & Crafts</Text>
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Acting &#127917;" checked={isActSelected} onPress={() => setIsActSelected(!isActSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Animation &#127916;" checked={isAnimSelected} onPress={() => setIsAnimSelected(!isAnimSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Calligraphy &#128395;" checked={isCalliSelected} onPress={() => setIsCalliSelected(!isCalliSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Crocheting &#128117;" checked={isCroSelected} onPress={() => setIsCroSelected(!isCroSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Dance &#128131;" checked={isDanSelected} onPress={() => setIsDanSelected(!isDanSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="DJing &#128191;" checked={isDJSelected} onPress={() => setIsDJSelected(!isDJSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Fashion &#128087;" checked={isFashSelected} onPress={() => setIsFashSelected(!isFashSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Filmmaking &#127909;" checked={isFilmSelected} onPress={() => setIsFilmSelected(!isFilmSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Painting &#127912;" checked={isPaiSelected} onPress={() => setIsPaiSelected(!isPaiSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Pottery &#127994;" checked={isPottSelected} onPress={() => setIsPottSelected(!isPottSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Sewing &#128117;" checked={isSewSelected} onPress={() => setIsSewSelected(!isSewSelected)} />

                <Text style={styles.section}>Collecting</Text>
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Action Figures &#127886;" checked={isFigSelected} onPress={() => setIsFigSelected(!isFigSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Car &#128663;" checked={isCarSelected} onPress={() => setIsCarSelected(!isCarSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Comic Book &#128215;" checked={isComSelected} onPress={() => setIsComSelected(!isComSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Record &#128191;" checked={isRecSelected} onPress={() => setIsRecSelected(!isRecSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Shoe &#128094;" checked={isShoeSelected} onPress={() => setIsShoeSelected(!isShoeSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Stamp &#128174;" checked={isStaSelected} onPress={() => setIsStaSelected(!isStaSelected)} />

                <Text style={styles.section}>Games</Text>
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Billiards &#127921;" checked={isBillSelected} onPress={() => setIsBillSelected(!isBillSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Bridge &#127183;" checked={isBridgeSelected} onPress={() => setIsBridgeSelected(!isBridgeSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Mahjong &#126980;" checked={isMahSelected} onPress={() => setIsMahSelected(!isMahSelected)} />
                <CheckBox fontFamily='Avenir' checkedColor='#75d2ff' title="Poker &#127183;" checked={isPokeSelected} onPress={() => setIsPokeSelected(!isPokeSelected)} />
