...
const EditProfile = ({ navigation, route }) => {
    ...
    const [tags, setTags] = useState({tags: {tag: '', tags: []}, tagsColor: '#3ca897', tagsText: '#fff'});

    return(
        <View style={{flex: 1, paddingTop: 15}}>
            <View style={styles.container}>
                <Image 
                    source={require('../assets/austin-wade-ex6qfO4TPMY-unsplash.jpg')}  
            ...
            <View style={styles.content}>
                ...
                <Text style={{ fontFamily: 'Avenir', fontSize: 16}}>Hobbies</Text>
                <View style={{flexDirection: 'row'}}>
                    <TouchableOpacity style={styles.tag}>
                        <Ionicons name="close-outline" size="16px" color="#ffffff" />
